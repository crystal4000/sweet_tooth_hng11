...
const Cart = () => {
  ...
  // Calculate subtotal for favorite products if cart is empty
  // const favoriteSubtotal = favoriteProducts.reduce(
  //   (acc, product) => acc + product.price,
  //   0
  // );

  // const subtotal = cartItems.length === 0 ? favoriteSubtotal : cartSubtotal;
  const delivery = 1000;
  // const total =
  //   cartItems.length === 0
  //     ? favoriteSubtotal + delivery
  //     : cartSubtotal + delivery;
